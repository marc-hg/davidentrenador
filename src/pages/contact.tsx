    ...
    <Layout>
      ...
      <div className="py-20 bg-black text-white">
        <div className="container mx-auto px-8">
          <h2 className="text-5xl md:text-6xl font-bold mb-8 text-red-500 max-w-6xl mx-auto">
            ¿Cómo pueden ayudarte mis entrenamientos?
          </h2>
          <div className="max-w-6xl mx-auto">
            <h3 className="text-2xl md:text-3xl text-gray-200 mb-8 font-light">
      ...
      {/* Red contact section */}
      <div className="bg-red-800 py-16 text-white">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col items-center">
              ...
              <h3 className="text-2xl mb-2">Teléfono</h3>
              <p className="text-xl">660 10 32 10</p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-xl">ramos_213@hotmail.com</p>
            </div>
          </div>
        </div>
      </div>
